...
public class UpperShootAnimation extends Transition {
    GameController gameController = new GameController();
    private Pane pane;
    private Ball ball;
    private CenterBall outerBall;
    private Text numberOfUpperBallsLeft;
    private Line line;
    private Text score;
...
//    }
    public UpperShootAnimation(Pane pane, Ball ball, CenterBall outerBall , Text numberOfUpperBallsLeft, ProgressBar progressBar, Line line, Text score) {
        ...
        this.numberOfUpperBallsLeft = numberOfUpperBallsLeft;
        this.line = line;
    ...
    protected void interpolate(double frac) {
        ...
        if (ball.getCenterX() > 140 && ball.getCenterX() < 150 + 66) {
            ...
            x = ball.getCenterX() - 1;
            textX = numberOfUpperBallsLeft.getX() - 1;
        }
        else {
            x = ball.getCenterX() - 4;
            textX = numberOfUpperBallsLeft.getX() - 4;
        ...
        if(outerBall.getBoundsInParent().intersects(ball.getLayoutBounds())) {
            ...
            try {
                GameController.rotate(ball, line, numberOfUpperBallsLeft);
            } catch (Exception e) {
